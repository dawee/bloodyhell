...
class b2PolyDef(b2ShapeDef):

    vertices = range(b2Settings.b2_maxPolyVertices),
    vertexCount = 0
    ...
    def __init__(self):
        ...
        self.groupIndex = 0
        self.vertices = range(b2Settings.b2_maxPolyVertices)
        self.type = b2Shape.e_polyShape
        self.vertexCount = 0
        for i in range(b2Settings.b2_maxPolyVertices):
            self.vertices[i] = b2Vec2()
